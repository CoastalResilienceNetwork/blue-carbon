...
function ( 	declare, PluginBase, ContentPane, dom, domStyle, domGeom, obj, content, esriapi, clicks, lang, Query, QueryTask ) {
	return declare(PluginBase, {
		...
		toolbarName:"Blue Carbon", showServiceLayersInLegend:false, allowIdentifyWhenActive:false, rendered:false, resizable:false,
		...
		initialize: function (frameworkParameters) {
			...
			this.url = "https://dev.services.coastalresilience.org/arcgis/rest/services/OceanWealth/Blue_Carbon/MapServer";
			this.layerDefs = [];
		},
